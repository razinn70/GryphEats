...
Source: `ops/docs/diagrams/system-architecture.mmd`

Render locally (option 1 - Mermaid CLI):
`mmdc -i ops/docs/diagrams/system-architecture.mmd -o ops/docs/diagrams/system-architecture.svg`

Render in VSCode: Open the `.mmd` file with Mermaid extension.

![System Architecture](./diagrams/system-architecture.png)

> Placeholder: generate `system-architecture.png` / `.svg` from the Mermaid source and commit for artifact traceability.
